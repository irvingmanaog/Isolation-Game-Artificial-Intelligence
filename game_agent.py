...
def custom_score(game, player):
    ...
    Center_Of_Board = (round(0.5*game.height)-1, round(0.5*game.width)-1); 
    ...
    dist2c_own = (current_position[0]-Center_Of_Board[0])**2 + (current_position[1]-Center_Of_Board[1])**2;
    dist2c_opp = (opp_pos[0]-Center_Of_Board[0])**2 + (opp_pos[1]-Center_Of_Board[1])**2;
...
def custom_score_3(game, player):
    ...
    Center_Of_Board = (round(0.5*game.height)-1, round(0.5*game.width)-1);
    dist2c = (Center_Of_Board[0]-current_position[0])**2+(Center_Of_Board[1]-current_position[1])**2
    ...
    if dist2c == 0:
        ...
        return w*len(my_moves)+(1-w)*(1/dist2c);  
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        if not legal_moves:
            ...
            if first_move_flag:
                Center_Of_Board = (round(0.5*game.height)-1, round(0.5*game.width)-1);
                if game.move_is_legal(Center_Of_Board):
